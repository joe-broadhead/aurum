...
> **v0.0.7** — SDK hardening residual: `SecretString` API key field, validated CLI merge, `try_*` transcript builders. Library API remains provisional on the 0.0.x line.
...
aurum-core = { git = "https://github.com/joe-broadhead/aurum", package = "aurum-core", tag = "v0.0.7" }
```
