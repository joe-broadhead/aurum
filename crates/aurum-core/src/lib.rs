...
pub use batch::{
    ...
    materialize_source_snapshot, merge_for_resume, operation_fingerprint, prepare_resume,
    sha256_file_full, truncate_error, validate_batch_stt_provider, verify_item_for_resume,
    verify_source_identity, work_indices, BatchItem, BatchItemStatus, BatchLock, BatchLockGuard,
    BatchManifest, BatchSummary, OperationFingerprintInput, ResumeDecision, SourceSnapshot,
    AUDIO_EXTENSIONS, BATCH_LOCK_NAME, BATCH_MANIFEST_NAME, BATCH_MANIFEST_VERSION,
