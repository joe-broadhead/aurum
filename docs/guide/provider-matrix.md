...
| `openrouter` | yes | yes | `OPENROUTER_API_KEY` | reviewed ASR + chat multimodal | `openai/gpt-4o-mini-tts*` | no | no |
...
| `xai` (`grok` alias) | yes | yes | `XAI_API_KEY` | `grok-asr*` | `grok-tts*` | no (REST only) | no |
