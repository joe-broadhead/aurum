...
Aurum turns audio files into text with **whisper.cpp on-device by default**, optional OpenRouter, and optional post-transcript cleanup. The same core powers the `aurum` CLI and embeds cleanly in other apps.
